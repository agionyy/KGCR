...
def parse_args():
    ...
    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="lastfm2k", help="Choose a dataset:[lastfm2k,ml100k,book-crossing]")
    parser.add_argument(
        "--data_path", nargs="?", default="data/", help="Input data path."
    )
    parser.add_argument('--model', default="KGCR", help='use MAE or not')
    # ===== Model Switch ===== #
    ...
    parser.add_argument('--cold_user_ratio', type=float, default=0.0,
                        help='Ratio of users used for cold-start experiment. Default=0.0 means disabled.')
